...
#bam_writer = HTSeq.BAM_Writer.from_BAM_Reader("Potential_Numts_With_Added_Tags.bam", alignment_file)

#header_file = subprocess.run(["samtools", "view", "-H", "ERR1019039.MT.csort.alignment.bam"], stdout=open('aln.bam','w'))
a = os.system("samtools view -H ERR1019039.MT.csort.alignment.bam > header_file")  
print(a)
#header_file = subprocess.run(["samtools", "view", "-H", "ERR1019039.MT.csort.alignment.bam"], stdout=open("ERR1019039.MT.csort.alignment.bam", "r"))
#print(header_file)
